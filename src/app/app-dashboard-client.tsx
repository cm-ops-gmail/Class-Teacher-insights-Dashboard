...
const parseDateString = (dateStr: string): Date | null => {
  ...
  // Handles formats like "Wed, Jan 1" and other common ones
  const parsed = new Date(dateStr);
  if(!isNaN(parsed.getTime())) return parsed;
  
  // Try adding current year for formats like 'Wed, Jan 1'
...
export default function AppDashboard() {
  ...
  >(() => {
    ...
    for (const col of allColumns) {
      visibility[col.key] = defaultVisibleColumns.includes(
        col.key as keyof AppClassEntry
      );
    }
  ...
  const filteredDataWithoutIssues = useMemo(() => {
    return data.filter(item => {
      ...
      if (productFilters.length > 0 && !productFilters.includes(item.product)) {
          return false;
      }
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="mb-8 space-y-2">
          ...
          <p className="text-muted-foreground">
            An interactive view of your Google Sheet data from the APP_Dashboard tab.
          </p>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:flex-wrap">
              <MultiSelectFilter
                title="Products"
                options={products.map(type => ({ value: type, label: type }))}
                selectedValues={productFilters}
                onSelectedValuesChange={setProductFilters}
                triggerClassName="w-full md:w-auto"
              />
              <MultiSelectFilter
                title="Subjects"
                options={subjects.map(course => ({ value: course, label: course }))}
...
const defaultVisibleColumns: (keyof AppClassEntry)[] = [
  "date",
  "product",
  "subject",
  "classTopic",
...
const allColumns: {key: keyof AppClassEntry, header: string, sortable?: boolean}[] = [
  { key: "date", header: "Date", sortable: true },
  { key: "product", header: "Product", sortable: true },
  { key: "subject", header: "Subject", sortable: true },
  { key: "classTopic", header: "Class Topic", sortable: true },
  { key: "scheduleTime", header: "Schedule Time", sortable: true },
  { key: "teacher", header: "Teacher", sortable: true },
  { key: "totalAttendance", header: "Total Attendance", sortable: true },
  { key: "classAttendancePercent", header: "Class Attendance %", sortable: true },
  { key: "classDuration", header: "Class Duration (Minutes)", sortable: true },
  { key: "averageWatchtime", header: "Average Watchtime (Minutes)", sortable: true },
  { key: "averageWatchtimePercent", header: "Average Watchtime %", sortable: true },
  { key: "averageClassRating", header: "Average Class Rating", sortable: true },
  { key: "issuesType", header: "Issues Type", sortable: true },
  { key: "teacherEntryTime", header: "Teacher Entry Time" },
  ...
  { key: "currentlyEnrolledUser", header: "Currently Enrolled User", sortable: true },
  { key: "userRatedPercent", header: "User Rated %" },
  { key: "uniqueUsersRated", header: "Unique Users Rated" },
  { key: "userCommentedPercent", header: "User Commented %" },
  { key: "totalDoubt", header: "Total Doubt" },
  { key: "userDoubtedPercent", header: "User Doubted %" },
  { key: "doubtStartedPercent", header: "Doubt Started %" },
  { key: "doubtResolvedPercent", header: "Doubt Resolved %" },
  { key: "pollParticipationPercent", header: "Poll participation %" },
  { key: "avgPollEngagedPercent", header: "Avg Poll Engaged %" },
  { key: "timeStamp", header: "Time Stamp" },
  { key: "liveClassId", header: "Live Class ID" },
